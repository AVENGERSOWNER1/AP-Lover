...
class BUTTONS(object):
    ...
    PBUTTON = [
        [
            InlineKeyboardButton("˹𝛅𝛕᧘ʀᴋ˼,", url="t.me/spicewine")
        ],
        [
    ...
    ABUTTON = [
        [
            InlineKeyboardButton("⌯ sυᴘᴘσʀᴛ ⌯", url="https://t.me/best_friends_world_chat"),
            InlineKeyboardButton("⌯ υᴘᴅᴧᴛєs ⌯", url="https://t.me/best_friends_world_chat"),
        ],
        [
